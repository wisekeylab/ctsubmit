...
- Optionally triggers CT policy-compliant SCT collection: Automatically determines how many SCTs of what types ([RFC6962](https://www.rfc-editor.org/rfc/rfc6962) and/or [Static CT API](https://c2sp.org/static-ct-api)) are needed/desired (and from how many distinct log operators) in order to satisfy whichever of the Chrome, Apple, Mozilla, and BIMI Group CT policies are applicable.
